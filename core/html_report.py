...
# 1. All literal CSS braces '{' and '}' are doubled to '{{' and '}}'.
# 2. The f-string typo 'f"<tr class."'{row_class}">' is fixed.
#
HTML_TEMPLATE = """
<!DOCTYPE html>
<html lang="en">
...
def generate_html_report(report_data, output_path="reports/report.html"):
    ...
    try:
        ...
        scan_time_obj = datetime.fromisoformat(scan_time)
        ...
        if result.get("status") == "error":
            ...
            if not findings:
                ...
                for finding in findings:
                    ...
                    # <-- FIX: Corrected the f-string SyntaxError here
                    section += (
    ...
    # --- Format the final HTML with both new blocks ---
    ...
    try:
        with open(output_path, "w", encoding="utf-8") as f:
            f.write(final_html)
        # This print is suppressed because main.py already prints the final path
